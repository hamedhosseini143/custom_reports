...
namespace Drupal\custom_report\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'month_and_year_widget' widget.
 *
 * @FieldWidget(
 *   id = "month_and_year_widget",
 *   module = "custom_report",
 *   label = @Translation("Month and year widget"),
 *   field_types = {
 *     "datetime"
 *   }
 * )
 */
class MonthAndYearWidget extends DateTimeWidgetBase {
